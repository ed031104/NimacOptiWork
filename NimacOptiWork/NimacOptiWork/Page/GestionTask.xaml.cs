...
namespace NimacOptiWork.Page
{
    ...
    public sealed partial class GestionTask : Microsoft.UI.Xaml.Controls.Page
    {
        ...
        public GestionTask()
        {
            ...
            ListTask.Add(new TaskItem { Title = "Tarea 1", Description = "Descripción de la tarea 1" });
            ListTask.Add(new TaskItem { Title = "Tarea 2", Description = "Descripción de la tarea 2" });
            ListTask.Add(new TaskItem { Title = "Tarea 1", Description = "Descripción de la tarea 1" });
            ListTask.Add(new TaskItem { Title = "Tarea 2", Description = "Descripción de la tarea 2" });
            ListTask.Add(new TaskItem { Title = "Tarea 1", Description = "Descripción de la tarea 1" });
            ListTask.Add(new TaskItem { Title = "Tarea 2", Description = "Descripción de la tarea 2" });
